...
export default function WaitlistPage() {
  return (
    <main className="min-h-screen bg-[#fcfaf7] text-[#171717] flex flex-col relative overflow-hidden selection:bg-[#943333]/10 selection:text-[#943333]">
      ...
      */}
      ...
      <section className="flex-1 bg-[radial-gradient(circle_at_top,_rgba(148,51,51,0.09),_transparent_55%)] flex flex-col items-center justify-center px-4 md:px-6 pt-24 pb-16 md:pb-24 relative z-10 text-center">
        <div className="w-full max-w-[460px] flex flex-col gap-6">
          ...
          <div>
            <h1 className="font-serif text-4xl md:text-5xl font-bold tracking-tight text-[#171717] mb-4 leading-[1.15]">
              ...
              <span className="text-[#943333] italic font-serif font-normal">beautifully.</span>
            </h1>
