...
function SidebarPreview() {
  return (
    <aside className="border-b border-[#e7e2d8] bg-white p-5 lg:border-b-0 lg:border-r lg:p-6">
      <div className="mb-5 flex items-center gap-3 border-b border-[#e7e2d8] pb-4">
        <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#faece7] text-lg text-[#d94f24]">
          ✂
        </div>
        <div>
...
export function DashboardPreview() {
  return (
    <section className="mx-4 px-2 pb-14 sm:mx-6 lg:mx-10 lg:pb-24">
      <div className="overflow-hidden rounded-[28px] border border-[#e7e2d8] bg-[#f7f4ee] shadow-[0_30px_90px_rgba(15,23,42,0.08)]">
