...
export function StepBusiness({
  ...
  return (
    <div>
      ...
      <h3 className="font-serif text-lg font-bold text-[#171717] mb-3">What type of business do you run?</h3>
      ...
      <div className="grid grid-cols-2 gap-2 max-h-[160px] overflow-y-auto mb-4 pr-1 custom-scrollbar">
        {options.map((opt) => (
          <button
            ...
            className={`p-3 rounded-xl text-left text-xs font-medium border flex items-center gap-2 transition ${businessType === opt.label ? "border-[#d24e2b] bg-[#d24e2b]/5 text-[#d24e2b]" : "border-[#e7e2d8] text-[#171717] hover:bg-[#fcfaf7]"}`}
          >
            <span>{opt.emoji}</span>
